...
# print(sequences)
# exit()
x_train, x_test, y_train, y_test = train_test_split(sequences, label, test_size=0.3333, random_state=42)
...
model.fit(x_train, y_train,
          ...
          epochs=epochs,
          validation_data=(x_test, y_test), callbacks=[TensorBoard(log_dir="./tmp/log")])
